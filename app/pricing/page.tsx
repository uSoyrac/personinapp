...
const TIERS = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Perfect for daily practice. Zero API cost.",
    badge: null,
    features: [
    ...
    limitations: [
      "No IELTS/TOEFL specific tests",
      "No AI Speaking Agent",
    ],
  ...
  },
  {
    ...
    price: "$4.99",
    period: "per month",
    description: "Full exam prep with extended limits.",
    badge: "Popular",
    features: [
      "IELTS Academic & TOEFL iBT",
      "Unlimited Reading & Vocabulary",
    ...
    ctaHref: "/practice",
    highlighted: true,
    color: "linear-gradient(135deg, rgba(99,102,241,0.15), rgba(16,185,129,0.06))",
  },
  {
    id: "gold",
    name: "Gold",
    price: "$12.99",
    period: "per month",
    description: "The ultimate package with AI speaking analysis.",
    badge: "Speaking Agent",
    features: [
      "Everything in Pro",
      "AI Speaking Agent",
      "Voice recording & analysis",
      "Pronunciation & Vocab feedback",
      "Sample speaking texts",
    ],
    limitations: [
      "Speaking Agent limited to 5/day",
    ],
    cta: "Get Gold",
    ctaHref: "/practice",
    highlighted: false,
            ...
            {TIERS.map((tier) => (
              <div
                ...
                style={{
                  ...
                  border: `${tier.highlighted ? "4px" : "2px"} solid #000`,
                  borderRadius: "0",
                  padding: "1.75rem",
                  position: "relative",
                  display: "flex",
                  ...
                  gap: "1.25rem",
                  boxShadow: tier.highlighted ? "8px 8px 0px #000" : "4px 4px 0px #000",
                }}
              >
                {tier.badge && (
                  <div
